...
class TareasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarea" do
    assert_difference('Tarea.count') do
      post tareas_url, params: { tarea: { descripcion: @tarea.descripcion, estado: @tarea.estado, id_tarea: @tarea.id_tarea, nombre: @tarea.nombre } }
    end
  ...
  test "should update tarea" do
    patch tarea_url(@tarea), params: { tarea: { descripcion: @tarea.descripcion, estado: @tarea.estado, id_tarea: @tarea.id_tarea, nombre: @tarea.nombre } }
