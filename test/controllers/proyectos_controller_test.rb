...
class ProyectosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proyecto" do
    assert_difference('Proyecto.count') do
      post proyectos_url, params: { proyecto: { descripcion: @proyecto.descripcion, fecha_fin: @proyecto.fecha_fin, fecha_inicio: @proyecto.fecha_inicio, id_sector: @proyecto.id_sector, nombre: @proyecto.nombre } }
    end
  ...
  test "should update proyecto" do
    patch proyecto_url(@proyecto), params: { proyecto: { descripcion: @proyecto.descripcion, fecha_fin: @proyecto.fecha_fin, fecha_inicio: @proyecto.fecha_inicio, id_sector: @proyecto.id_sector, nombre: @proyecto.nombre } }
