...
class RolUsuariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rol_usuario" do
    assert_difference('RolUsuario.count') do
      post rol_usuarios_url, params: { rol_usuario: { nombre: @rol_usuario.nombre, usuario_id: @rol_usuario.usuario_id } }
    end
  ...
  test "should update rol_usuario" do
    patch rol_usuario_url(@rol_usuario), params: { rol_usuario: { nombre: @rol_usuario.nombre, usuario_id: @rol_usuario.usuario_id } }
