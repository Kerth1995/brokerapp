...
class DocumentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create documento" do
    assert_difference('Documento.count') do
      post documentos_url, params: { documento: { descripcion: @documento.descripcion, nombre: @documento.nombre } }
    end
  ...
  test "should update documento" do
    patch documento_url(@documento), params: { documento: { descripcion: @documento.descripcion, nombre: @documento.nombre } }
